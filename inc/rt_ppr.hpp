...
#define BTJsonFileName "/var/lib/amd-ppr/BtPPRData.json"
#define RTJSON_FILE "RtPPRData.json"
#define RTJsonFileName "/var/lib/amd-ppr/RtPPRData.json"
...
const int OFF_STATE_SLEEP_SEC = 30;
